...
def create_app():
    ...
    app.config.setdefault("UPLOAD_ROOT", os.path.join(root_dir, "uploads"))
    app.config.setdefault("MAX_CONTENT_LENGTH", 3 * 1024 * 1024)  # 3MB
    os.makedirs(app.config["UPLOAD_ROOT"], exist_ok=True)
    os.makedirs(os.path.join(app.config["UPLOAD_ROOT"], "avatars", "alunos"), exist_ok=True)
